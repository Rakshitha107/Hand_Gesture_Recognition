...
import cv2
import math
# hand detector module for hand detection using mediapipe
...
# Videocapture object to capture video from camera
cap = cv2.VideoCapture(0)

# detector object to detect hands in frame
detector = hd.handDetector()

# enters loop to read frames
while True:
